...
class Download:
    ...
    def set_oa_mask_dataset_via_wcs(self):
        ...
        try:
            ...
            self._oa_mask_dataset = gdal.Open(out_fp, gdal.GA_ReadOnly)
    ...
    def get_percent_out_of_bounds_mask_pixels(self):
        ...
        if self._oa_mask_dataset is not None:
            mask_arr = self._oa_mask_dataset.ReadAsArray()
    ...
    def is_mask_valid(self, quality_flags, max_out_of_bounds, max_invalid_pixels):
        ...
        if self._oa_mask_dataset is None:
            return False
    ...
    def set_band_dataset_nodata_via_mask(self, quality_flags, no_data_value):
        ...
        band_arr = self._band_dataset.ReadAsArray()
        ...
        self._band_dataset.WriteArray(band_arr)
